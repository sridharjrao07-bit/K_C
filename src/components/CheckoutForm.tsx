  ...
  return (
    <>
      <div className="mb-8 items-center flex gap-2 text-sm text-gray-500">
        <Link href="/" className="hover:text-[#c65d51]">{t("nav.home")}</Link>
        <span>/</span>
        <span className="text-[#6f5c46] font-semibold">{t("checkout.title")}</span>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-lg border border-[#e5d1bf]">
            <h3 className="text-xl font-bold text-[#6f5c46] mb-4">{t("checkout.orderSummary")}</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#faf7f2] p-4 rounded-xl text-center">
              ...
              <p className="text-xs font-semibold text-[#6f5c46]">{t("checkout.secure")}</p>
            </div>
            <div className="bg-[#faf7f2] p-4 rounded-xl text-center">
              <svg className="w-8 h-8 text-[#6f5c46] mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <p className="text-xs font-semibold text-[#6f5c46]">{t("checkout.verified")}</p>
            </div>
          </div>
        </div>
      </div>
